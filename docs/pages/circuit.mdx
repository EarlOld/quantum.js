...
Applies the T gate to the specified qubit. PI/4 rotation over Z-axis (synonym for r4)

#### `s(qubitIndex: number): void`
Applies the S gate to the specified qubit. PI/2 rotation over Z-axis (synonym for r2)
...
#### `crx(controlQubitIndex: number, targetQubitIndex: number, theta: number): void`
Applies the controlled-RX gate with a specified angle.
