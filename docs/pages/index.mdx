...
Try our interactive examples with 3D Bloch sphere visualization:

👉 **[quantum-js-examples.iot-sdn.space](https://quantum-js-examples.iot-sdn.space)**

Explore quantum gates, Bell states, superposition, entanglement, and more!
...
| CRX-gate            | crx(controlIndex: number, targetIndex: number, theta: number) |
